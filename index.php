        ...
        <div>
            <?php foreach($contacts as $contact): ?>
                <a href="index.php?id=<?php echo $contact['id']; ?>">
                    <div class="flex flex-row border-gray-200 border-2 items-center py-3 px-5 my-3 w-7/12 rounded-lg justify-between text-gray-600" id="viewModal">
                ...
                <div class="flex flex-col">
                    <form action="index.php" method="post" enctype="multipart/form-data">
                        <div class="flex flex-row justify-between items-center text-center">
                            ...
                            <h1 class="text-2xl font-semibold pb-5 text-center">Create a New Contact</h1>
            ...
            <div class="bg-white m-auto p-12 border-2 border-gray-400 w-6/12 rounded-lg text-slate-600 font-medium">
                <div class="flex flex-col">
                    <form action="index.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-row justify-between items-center text-center">
                            <!-- <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg> -->
                            <h1 class="text-2xl font-semibold pb-5">View a Contact</h1>
                            <div class="close">&times;</div>
                        </div>
                        <div class="flex flex-col pb-7 gap-1">
                            <h3>Contact Name</h3>
